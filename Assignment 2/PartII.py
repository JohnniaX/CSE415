...
# Finds any intermediate and complex redundancies and returns a list
...
# Finds any simple indirect redundancies and returns a list of
# the relevant words
...
# Used by the simple direct redundancy detection
